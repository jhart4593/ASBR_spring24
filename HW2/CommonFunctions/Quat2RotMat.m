...
%+ Reference: ASBR W3-L1 notes or https://en.wikipedia.org/wiki/Quaternions_and_spatial_rotation
%+ Revision List: 
...
% (note norm of a vector is same as taking quat norm, it can be showen
